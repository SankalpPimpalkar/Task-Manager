...
import { AlertCircle, CalendarClock, CirclePlus, LogOut, UserRound, CheckCircle2, Clock } from 'lucide-react';
...
export default function Sidebar() {
    ...
    // Navigation items data - removed Completed and Do It Now for mobile
    ...
    return (
        <>
                    ...
                    <ul className='space-y-2'>
                        ...
                        <li>
                            <button
                                ...
                                className='flex items-center w-full px-4 py-3 rounded-lg bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 hover:text-blue-300 transition-colors duration-200 cursor-pointer'
                            >
                                <CirclePlus className='w-5 h-5 mr-3' />
                        ...
                        {navItemsDesktop.map((item, index) => (
                            <li key={index}>
                                ...
                                >
                                    <item.icon className={`w-5 h-5 mr-3 ${isActive(item.path) ? 'text-white' : item.iconColor
            ...
            <div div className='md:hidden fixed bottom-0 left-0 right-0 border-t border-[#1d1f29] bg-[#11131e] z-50' >
                <ul className='flex justify-around px-4'>
                    ...
                    <li className='flex-1'>
                        <button
                            onClick={handleOpenAddNewModal}
                            className='flex flex-col items-center py-3 text-blue-400 hover:text-blue-300 transition-colors duration-200'
                        >
                            <CirclePlus className='w-5 h-5 mb-1' />
